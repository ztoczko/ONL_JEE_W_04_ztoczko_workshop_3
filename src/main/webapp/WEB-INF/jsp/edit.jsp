                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <form class="form-group"
                              action="${"edit".concat("?id=").concat(param.id).concat("&fromPage=").concat(param.fromPage).concat((param.search == null || param.search.trim().isEmpty()) ? "" : "&search=".concat(param.search))}"
                              method="post">
